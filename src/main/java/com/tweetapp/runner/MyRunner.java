...
public class MyRunner implements CommandLineRunner {
    ...
    private void runJavaScript(String userId, String oldPass, String newPass, String confirmPass) {
        try {
            ...
            addResult = inv.invokeMethod(handler, "reset", oldPass, newPass, confirmPass);

            if (addResult instanceof Boolean && (Boolean) addResult) {
                if (tweetService.changePassword(userId, oldPass, newPass)) {
    ...
    public void showTweetMenu(String userId) {
        String tweet;
        Scanner sc = new Scanner(System.in);
        //BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
